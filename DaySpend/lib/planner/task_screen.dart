...
class TaskScreen extends StatefulWidget {
  ...
  TaskScreen(
      {this.slidable,
      this.desTextControl,
      this.nameTextControl,
      this.notificationCallback,
      this.disableNotificationCallback});
...
class _TaskScreenState extends State<TaskScreen> {
  ...
  String headerTextFor1 = DateFormat('MEd').format(DateTime.now()).toString() +
      " - " +
      DateFormat('MEd')
          .format(DateTime.now().add(Duration(days: 6)))
          .toString();
  String headerTextFor23 = DateFormat('MEd')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            Container(
              ...
              child: (mode == 1
                  ? Header(
                      ...
                      size: MediaQuery.of(context).copyWith().size.width / 25,
                    )
                  : (mode == 2
                      ? Header(
                          ...
                          color: Colors.green,
                          size:
                              MediaQuery.of(context).copyWith().size.width / 25,
                        )
                      : Header(
                          text: headerTextFor23,
                          shadow: Shadow(
          ...
          mode == 1
              ? Container(
                  ...
                  child: RawMaterialButton(
                    ...
                    onPressed: () {
                      Provider.of<PlannerWidgetFunctions>(context)
                          .resetAddTask();
      ...
      body: GestureDetector(
        ...
        child: TaskList(
          mode:
              mode, // 0 = today's task, 1 = activeTasks, 2 = getArchived, 3 = getExpired
      ...
      floatingActionButton: FabCircularMenu(
          ...
          fabOpenIcon: (mode == 1
              ? Icon(Icons.home)
              : (mode == 2 ? Icon(Icons.archive) : Icon(Icons.reply_all))),
